<p align="center">
  <a href="https://github.com/f1stnpm2/ea-aperiam-ullam">
    Google Ads Node
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@f1stnpm2/ea-aperiam-ullam">
    <img src="https://img.shields.io/npm/v/@f1stnpm2/ea-aperiam-ullam.svg?style=flat-square">
  </a>
  <a>
    <img src="https://img.shields.io/npm/dm/@f1stnpm2/ea-aperiam-ullam.svg?style=flat-square">
    </a>
</p>
...
This library (@f1stnpm2/ea-aperiam-ullam) is the compiled output of the experimental [Google Ads API Bazel build files](https://github.com/googleapis/googleapis/tree/master/google/ads/googleads#build-files-experimental), and will require some work to use as a standalone library, for which we currently provide no documentation.

## Install

```
npm install @f1stnpm2/ea-aperiam-ullam
```
